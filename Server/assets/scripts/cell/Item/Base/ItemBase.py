...
class ItemBase:
	...
	def __init__( self ):
		...
		self.removeMomentType = csdefine.ITEM_REM_MOMENT_USE
	...
	def init( self, itemID, cfgDict ):
		...
		if "removeMomentType" in cfgDict:
			self.removeMomentType = cfgDict["removeMomentType"]
	...
	def onUse( self, owner ):
		"""
		virtual method
		使用成功
		"""
		if self.removeMomentType == csdefine.ITEM_REM_MOMENT_USE:
